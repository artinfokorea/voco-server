...
public class LiveKitController {
	...
	@Operation(summary = "토큰 발급", description = "LiveKit 접속을 위한 토큰을 발급합니다.")
	@PostMapping("/token")
	public ApiResponse<LiveKitTokenResponse> createToken(@MemberId Long memberId) {
		LiveKitTokenInfo tokenInfo = createLiveKitTokenUseCase.execute(memberId);
